...
# resume_from = "/home/hd10/mmdetection3d/outputs/ds/mp_rank_00_model_states.pt"
checkpoint_config = dict(_delete_=True, interval=1000, by_epoch=False, max_keep_ckpts=5)
...
train_pipeline = [
    # dict(type='LoadPointsFromFile', coord_type='LIDAR', load_dim=5, use_dim=[0,1,2,4]),
    dict(type="LoadPointsFromFile", coord_type="LIDAR", load_dim=5, use_dim=5),
    dict(type="LoadPointsFromMultiSweeps", sweeps_num=5),
...
model = dict(
    ...
    pts_voxel_encoder=dict(
        feat_channels=[32, 64], point_cloud_range=[-100, -100, -5, 100, 100, 3]
    ),
